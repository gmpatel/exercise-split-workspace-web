...
$(document).ready(function () {
    ...
    $('#mainSplitter').jqxSplitter({ width: '100%', height: '100%', orientation: 'vertical', panels: [{ size: '50%', collapsible: false }, { size: '50%', collapsible: false }] });
...
function addTab(jqxTabsId, url, label, item) {
    ...
    $(jqxTabsId).jqxTabs('setContentAt', 1, '<div class="jqxTabsHeader"></div><iframe class="jqxTabsContentIframe" src="' + url + '" ></iframe>');
}
